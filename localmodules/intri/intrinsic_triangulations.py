...
def next_side(fs):
    ...
    (This method serves mainly to make code more readable.)
...
def other(G, fs):
    """
    For a given face-side fs, returns the neighboring face-side in some other
    triangle.
...
def build_gluing_map(F):
    ...
    :param F: |F|x3 vertex-face adjacency list F describing a manifold,
    oriented triangle mesh without boundary.
